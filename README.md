...
A Tour of Standard ML is built using [Hakyll](https://jaspervdj.be/hakyll/); this repository hosts the source for the site generator. The content is also reproduced here in README form for convenience.
